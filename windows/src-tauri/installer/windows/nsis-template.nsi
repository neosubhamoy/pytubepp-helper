...
!define UNINSTALLERSIGNCOMMAND "$\"C:\\Program Files (x86)\\Windows Kits\\10\\bin\\10.0.26100.0\\x64\\signtool.exe$\" $\"sign$\" $\"/fd$\" $\"sha256$\" $\"/sha1$\" $\"c12a1579698a3cc86ef3b2c942172cd995149b10$\" $\"/d$\" $\"pytubepp-helper$\" $\"/t$\" $\"http://timestamp.sectigo.com$\" $\"%1$\""
